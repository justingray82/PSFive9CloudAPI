function Get-Five9CloudPrompts {
    [CmdletBinding()]
    param (
        [string]$Fields,
        [string]$Sort,
    ...
    $uri = "$($global:Five9CloudToken.RestBaseUrl)/v1/domains/$($global:Five9CloudToken.DomainId)/prompts-v2"
    ...
    try {
        ...
        Write-Error "Failed to list prompts: $_"
    }
}