function New-Five9CloudOutboundCampaign {
    param(
    ...
    if ($result -ne $false) { Write-Host "Outbound campaign '$Name' created successfully."; return $result } else { Write-Host "Failed to create outbound campaign '$Name'."; return $false }
}
