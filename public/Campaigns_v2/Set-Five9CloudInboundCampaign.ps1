function Set-Five9CloudInboundCampaign {
    ...
    if ($result -ne $false) { Write-Host "Inbound campaign '$CampaignName' updated successfully."; return $result } else { Write-Host "Failed to update inbound campaign '$CampaignName'."; return $false }
}
