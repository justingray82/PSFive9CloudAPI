function Get-Five9CloudCampaignProfiles {
    ...
    Invoke-Five9CloudPagedApi (Set-Five9CloudQueryUri "campaigns/v1/domains/$($global:Five9.DomainId)/campaign-profiles" $q)
}
