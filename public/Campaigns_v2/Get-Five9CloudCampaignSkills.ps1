function Get-Five9CloudCampaignSkills {
    ...
    Invoke-Five9CloudPagedApi (Set-Five9CloudQueryUri "campaigns/v1/domains/$($global:Five9.DomainId)/campaigns/$CampaignId/skills" $q)
}
