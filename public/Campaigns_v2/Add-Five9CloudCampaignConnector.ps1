function Add-Five9CloudCampaignConnector {
    ...
    if ($result -ne $false) { Write-Host "$ConnectorName added to $CampaignName"} else { Write-Host "Failed to add $ConnectorName to $CampaignName"; return }
}