function Get-Five9CloudReasonCodeSetList {
    ...
    Invoke-Five9CloudPagedApi (Set-Five9CloudQueryUri "agent-sessions/v1/domains/$($global:Five9.DomainId)/reason-code-sets" $q)
}